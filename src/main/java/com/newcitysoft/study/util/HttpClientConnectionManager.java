package com.newcitysoft.study.util;
...
public class HttpClientConnectionManager {
	private static RequestConfig defaultRequestConfig = RequestConfig.custom().setSocketTimeout(10000).setConnectTimeout(2000).setConnectionRequestTimeout(30000).setRedirectsEnabled(true).build();
